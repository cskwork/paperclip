...
export function SidebarAccountMenu({
  ...
  const secondaryLabel =
    session?.user.email?.trim() || t(deploymentMode === "authenticated" ? "account.signedIn" : "account.localWorkspaceBoard");
  const accountBadge = t(deploymentMode === "authenticated" ? "account.account" : "account.local");
        ...
        >
          ...
          <div className="-mt-8 px-4 pb-4">
            ...
            <div className="mt-4 space-y-1">
              ...
              <LocaleToggle onAfterToggle={() => setOpen(false)} />
